...
<head>
  ...
  <title>Sports Wear Manufacturing | Primgar International</title>
  <meta name="description" content="Custom Sports Wear Manufacturing at Primgar International. Jerseys, Tights, Shorts, Gym Wear.">
...
<body class="smooth-scroll">
  ...
  <section class="page-hero">
    <div class="container">
      <h1 class="reveal-up">Sports Wear</h1>
      <div class="breadcrumb reveal-up" style="transition-delay: 0.1s;">
        <a href="index.php">Home</a> / Sports Wear
      </div>
    </div>
  </section>
  ...
  <section class="street-section container">
    <div style="text-align: center; max-width: 800px; margin: 0 auto;" class="reveal-up">
      ...
      <h2 style="font-size: clamp(2rem, 4vw, 3rem); margin: 10px 0 20px;">Performance Sportswear Manufacturing</h2>
      <p style="color: var(--text-secondary); font-size: 1.1rem; line-height: 1.6;">We create performance-focused activewear with the right stretch, breathability, fit and durable branding for your team or fitness label.</p>
    </div>

    <div class="cat-grid">
      <div class="cat-item reveal-up">
        <img src="<?= htmlspecialchars($web_images['sports_wear_cats'][0]['image_path'] ?? 'images/cat_sportswear.png') ?>" alt="<?= htmlspecialchars($web_images['sports_wear_cats'][0]['alt_text'] ?? 'Hoodies') ?>" class="cat-img">
        <div class="cat-info">
          <h3>Team Jerseys</h3>
          <p style="color: var(--text-muted); font-size: 0.95rem;">Moisture-wicking performance knits</p>
        </div>
      </div>
      <div class="cat-item reveal-up" style="transition-delay: 0.1s;">
        <img src="<?= htmlspecialchars($web_images['sports_wear_cats'][1]['image_path'] ?? 'images/printing.png') ?>" alt="<?= htmlspecialchars($web_images['sports_wear_cats'][1]['alt_text'] ?? 'T-Shirts') ?>" class="cat-img">
        <div class="cat-info">
          <h3>Training Tops</h3>
          <p style="color: var(--text-muted); font-size: 0.95rem;">Lightweight and breathable fabrics</p>
        </div>
      </div>
      <div class="cat-item reveal-up" style="transition-delay: 0.2s;">
        <img src="<?= htmlspecialchars($web_images['sports_wear_cats'][2]['image_path'] ?? 'images/patternmaking.png') ?>" alt="<?= htmlspecialchars($web_images['sports_wear_cats'][2]['alt_text'] ?? 'Bottoms') ?>" class="cat-img">
        <div class="cat-info">
          <h3>Leggings & Shorts</h3>
          <p style="color: var(--text-muted); font-size: 0.95rem;">Four-way stretch and compression</p>
        </div>
      </div>
      <div class="cat-item reveal-up" style="transition-delay: 0.3s;">
        <img src="<?= htmlspecialchars($web_images['sports_wear_cats'][3]['image_path'] ?? 'images/finishing.jpg') ?>" alt="<?= htmlspecialchars($web_images['sports_wear_cats'][3]['alt_text'] ?? 'Jackets') ?>" class="cat-img">
        <div class="cat-info">
          <h3>Tracksuits & Layers</h3>
          <p style="color: var(--text-muted); font-size: 0.95rem;">Warm-up jackets and pants</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="street-section container">
    <div class="content-row">
      ...
      <div class="content-image-wrapper reveal-up" style="transition-delay: 0.2s;">
        <img src="<?= htmlspecialchars($web_images['sports_wear_services'][0]['image_path'] ?? 'images/printing.png') ?>" alt="<?= htmlspecialchars($web_images['sports_wear_services'][0]['alt_text'] ?? 'Screen Printing') ?>">
      </div>
    </div>
    ...
    <div class="content-row reverse">
      ...
      <div class="content-image-wrapper reveal-up" style="transition-delay: 0.2s;">
        <img src="<?= htmlspecialchars($web_images['sports_wear_services'][1]['image_path'] ?? 'images/sourcing.jpg') ?>" alt="<?= htmlspecialchars($web_images['sports_wear_services'][1]['alt_text'] ?? 'Fabric Selection') ?>">
      </div>
    </div>
    ...
    <div class="content-row">
      ...
      <div class="content-image-wrapper reveal-up" style="transition-delay: 0.2s;">
        <img src="<?= htmlspecialchars($web_images['sports_wear_services'][2]['image_path'] ?? 'images/embroidery.png') ?>" alt="<?= htmlspecialchars($web_images['sports_wear_services'][2]['alt_text'] ?? 'Embroidery') ?>">
      </div>
    </div>
  </section>
  ...
  <section class="whatsapp-cta-banner">
    <div class="container" style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 24px;">
      <div>
        <h3 style="font-size: 1.5rem; font-weight: 800; margin-bottom: 4px;">Ready to Build Your Sportswear Line?</h3>
        <p style="color: rgba(255,255,255,0.75); font-size: 0.95rem;">Get a free quote within 12 hours. Min MOQ 10 pcs.</p>
      </div>
      <div style="display: flex; gap: 16px; flex-wrap: wrap;">
        <a href="https://wa.me/923147560683?text=Hi%2C%20I%27m%20interested%20in%20Sports%20Wear%20manufacturing%20with%20Primgar%20Wears." target="_blank" rel="noopener noreferrer" class="btn-whatsapp-cta magnetic">
